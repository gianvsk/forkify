            ...
            <div className='navbar-div-collapse'>
              ...
              <Navbar.Text className='d-flex align-items-center p-0'>
                <div className="container-navbar-text d-flex flex-row justify-content-center h-100">
                  ...
                  <button className='container-navbar-text__button d-flex align-items-center p-3' onClick={handleShow}><img src='svg/bookmark.png' className='mb-1' width="30" height="30" alt="bookmark icon" />BOOKMARKS</button>
                </div>
              </Navbar.Text>
            </div>
          </Navbar.Collapse>
